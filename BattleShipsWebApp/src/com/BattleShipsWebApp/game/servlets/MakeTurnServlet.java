...
@WebServlet(name = "MakeTurnServlet", urlPatterns = {"/gamesRoom/makeTurn"})
public class MakeTurnServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (gameRecord != null) {
            ...
            Game.HitStatus hitStatus = gameRecord.makeTurn(new Point(Integer.parseInt(valuesArr[0]), Integer.parseInt(valuesArr[1])),
                    System.currentTimeMillis());
            if (hitStatus == Game.HitStatus.MISS){
